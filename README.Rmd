...
```{r setup, echo=FALSE}
library(knitr)
opts_chunk$set(comment = "", message = FALSE, warning = FALSE, eval=FALSE)
# in this version of the document, the code is disabled
# and some results are copied and pasted in
# for the original version that runs, see
# https://github.com/rdrr1990/kms4tf/blob/master/original_kms_demo.Rmd
```
